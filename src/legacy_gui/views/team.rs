        ...
        if let Some(ref db) = app.team_database {
            ...
            ui.horizontal(|ui| {
                ...
                egui::ComboBox::from_label("")
                    ...
                    .show_ui(ui, |ui| {
                        if ui
                            .selectable_label(app.selected_league.is_none(), "-- Select League --")
                            .clicked()
                        {
                        ...
                        for league in &leagues {
                            if ui
                                .selectable_label(
                                    app.selected_league.as_ref() == Some(league),
                                    league,
                                )
                                .clicked()
                            {
                        ...
                        egui::ComboBox::from_label(" ")
                            ...
                            .show_ui(ui, |ui| {
                                ...
                                for (key, team) in &teams {
                                    if ui
                                        .selectable_label(
                                            app.selected_team_key.as_ref() == Some(key),
                                            &team.display_name,
                                        )
                                        .clicked()
                                    {
            ...
            if league_changed {
                ...
                if let (Some(ref league), Some(ref team_key)) =
                    (&app.selected_league, &app.selected_team_key)
                {
