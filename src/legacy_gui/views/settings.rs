...
use crate::legacy_gui::state::save_capture_image;
...
pub fn render_settings(app: &mut FMGoalMusicsApp, ui: &mut egui::Ui, ctx: &egui::Context) {
    ...
    theme::card_frame().show(ui, |ui| {
...

        {
            ...
            ui.checkbox(
                &mut state.enable_morph_open,
                "Enable Morphological Opening (noise reduction)",
            );
        }
    });
    ...
    theme::card_frame().show(ui, |ui| {
        ...
        ui.horizontal(|ui| {
            ...
            if ui
                .add(egui::Slider::new(&mut music_vol_percent, 0..=100).suffix("%"))
                .changed()
            {
        ...
        ui.horizontal(|ui| {
            ...
            if ui
                .add(egui::Slider::new(&mut ambiance_vol_percent, 0..=100).suffix("%"))
                .changed()
            {
        ...
        ui.horizontal(|ui| {
            ...
            if ui
                .add(
                    egui::Slider::new(&mut music_length_seconds, 0.0..=60.0)
                        .suffix(" seconds")
                        .step_by(1.0),
                )
                .changed()
        ...
        ui.horizontal(|ui| {
            ...
            if ui
                .add(
                    egui::Slider::new(&mut ambiance_length_seconds, 0.0..=60.0)
                        .suffix(" seconds")
                        .step_by(1.0),
                )
                .changed()
